...
describe('author', () => {
  test('Robert Jordan', async () => expect(parse.author(await getGenericUrl(urls.robertJordan))).toEqual({
    name: 'Robert Jordan',
  ...
  test('Brandon Sanderson', async () => expect(parse.author(await getGenericUrl(urls.brandonSanderson))).toEqual({
  ...
  test('George Orwell', async () => expect(parse.author(await getGenericUrl(urls.georgeOrwell))).toEqual({
    name: 'George Orwell',
