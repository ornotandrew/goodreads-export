...
exports.getAllReviewIds = util_1.asyncMemo(function (listId, multibar) { return __awaiter(void 0, void 0, void 0, function () {
    var bar, allReviewIds, page, _a, reviewIds, progress, isLastPage, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                if (page === 1) {
                    bar = multibar.create(progress.total, progress.current, util_1.barOptions('Review IDs', '📋'));
                }
                else {
...
exports.getReviewInfo = util_1.asyncMemo(function (reviewId) { return __awaiter(void 0, void 0, void 0, function () {
