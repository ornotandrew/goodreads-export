...
exports.getBook = exports.getReview = exports.getListPage = void 0;
...
exports.getBook = function (url) { return axios_1.default.get(url, { headers: { 'Accept': 'text/html' } }).then(function (resp) { return resp.data; }); };
